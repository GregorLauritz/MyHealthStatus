...
import app.readylytics.health.core.model.domain.model.circadianConsistencyStatus
...
class CircadianConsistencyRepository
    ...
    constructor(
        ...
        private fun compute(
            ...
            val rawBedtimeOffsetMinutes = normalizeMinutes(evalSessions.first().startTime, zone) - medianBed
